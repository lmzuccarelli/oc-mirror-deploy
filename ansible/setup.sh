...
sed -i "s/ansible_sudo_pass: [a-zA-Z0-9\*\!i\-]*/ansible_sudo_pass: ${ANSIBLE_SUDO_PASSWORD}/g" roles/certs/vars/server.yml
...
# add relevant special chars for your password 
sed -i "s/ansible_sudo_pass: [a-zA-Z0-9\*\!\-]*/ansible_sudo_pass: ${ANSIBLE_SUDO_PASSWORD}/g" roles/golang/vars/main.yml
...
sed -i "s/ansible_sudo_pass: [a-zA-Z0-9\*\!\-]*/ansible_sudo_pass: ${ANSIBLE_SUDO_PASSWORD}/g" roles/mirror-registry/vars/main.yml
...
sed -i "s/ansible_sudo_pass: [a-zA-Z0-9\*\!\-]*/ansible_sudo_pass: ${ANSIBLE_SUDO_PASSWORD}/g" roles/oc-mirror/vars/main.yml
